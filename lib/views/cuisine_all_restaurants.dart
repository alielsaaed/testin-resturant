...
import '/Controllers/cuisine_wise_restaurants.dart';
import '/utils/font_size.dart';
import '/utils/theme_colors.dart';
import '/views/restaurant_details.dart';
import '/widgets/shimmer/restaurant_by_cuisine_shimmer.dart';
...
class CuisineAllRestaurents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CuisineWiseRestaurants>(
      init: CuisineWiseRestaurants(cuisineId),
      builder: (allRestaurants) => allRestaurants.cuisineWiseRestaurantsLoader
          ? CuisineAllRestaurentShimmer(
              cuisineId: cuisineId, cuisineTitle: cuisineTitle)
          : Scaffold(
              appBar: AppBar(
                leading: IconButton(
                    onPressed: () {
              ...
              body: allRestaurants.restaurantList.length == 0
                  ? NoRestaurantFound()
                  : Container(
                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsets.only(
                                                            left: 10.0),
                                                    child: Text(
                                                      "(${allRestaurants.restaurantList[index].avgRatingUser!.toInt()})  reviews",
                                                      style: TextStyle(
                                                          color: Colors.grey),
                                                    ),
                                                  )
